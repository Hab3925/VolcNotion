...
export interface PagesUpdateParameters extends PagesUpdatePathParameters, PagesUpdateQueryParameters, PagesUpdateBodyArchiveParameter, PagesUpdateBodyPropertiesParameters {
}
...
export declare const pagesUpdate: {
    ...
    readonly pathParams: readonly ["page_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["archived", "properties"];
